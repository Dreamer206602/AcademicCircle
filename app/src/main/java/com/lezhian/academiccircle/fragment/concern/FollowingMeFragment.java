 ...
 * 关注我的界面
 */
public class FollowingMeFragment extends BaseFragment
        implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {

    public static volatile FollowingMeFragment mInstance = null;
    ...
    public static FollowingMeFragment getInstance() {
        FollowingMeFragment inst = mInstance;//创建临时变量
        if (inst == null) {
            synchronized (FollowingMeFragment.class) {
                inst = mInstance;
                if (inst == null) {
                    inst = new FollowingMeFragment();
                    mInstance = inst;
                }
            }
        }
    ...
    protected View initView() {
        return View.inflate(UIUtils.getActivity(), R.layout.fragment_following_me, null);
    }
